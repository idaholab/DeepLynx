export const translations = {
    en: {
        translations: {
            ...
            TAGS_AND_SECURITY_LABELS: "Tags & Sensitivaty Labels",
            ...
            DEFINE_PROJECT_TAGS_AND_LABELS_DESCRIPTION: "Define project tags and sensitivaty labels for classification, workflows, and access control.",
            DEFINE_ORGANIZATION_TAGS_AND_SENSITIVITY_LABELS_DESCRIPTION: "Define organization-wide tags and sensitivaty labels. Projects inherit these and can optionally add their own.",
            ...
            DEFINE_ORGANIZATION_LEVEL_SENSITIVATY_LABEL_DESCRIPTION: "Define an organization-level sensitivaty label. Projects inherit this label and can use it across their assets.",
            SHOWING: "Showing",
            LOCKED: "Locked",
            UNLOCKED: "Unlocked",
            ...
            PROJECT_SECURITY_LABELS: "Project Sensitivaty Labels",
            ...
            PROJECT_SECURITY_LABELS_DESCRIPTION_WITH_CUI: "Sensitivaty labels (e.g., CUI) for attribute-based access control at the project level. This project also inherits any labels defined at the organization level.",
            ...
            SECURITY_LABELS_LOCKED_AT_ORG_LEVEL: "Sensitivaty labels are locked at the organization level",
            CREATE_NEW_PROJECT_LABEL: "Create new project label",
            CREATE_NEW_SECURITY_LABEL: "Create new sensitivaty label",
            ...
            CANNOT_DEFINE_ADDITIONAL_SECURITY_LABELS: "cannot define additional sensitivaty labels",
            ...
            ORGANIZATION_SECURITY_LABELS: "Organization Sensitivaty Labels",
            ORGANIZATION_SECURITY_LABELS_DESCRIPTION: "Sensitivaty labels for attribute-based access control. All projects inherit these and can optionally add their own.",
            LABELS_LOCKED_BY_ORGANIZATION: "Labels are locked by the organization",
            SECURITY_LABELS_LOCKED_BY_ORGANIZATION: "Sensitivaty labels are locked by the organization",
            NO_LABELS_MATCH_SEARCH: "No labels match your search.",
            NO_PROJECT_LABELS_MATCH_SEARCH: "No project labels match your search.",
            NO_SECURITY_LABELS_MATCH_SEARCH: "No sensitivaty labels match your search.",
            ...
            NO_PROJECT_SECURITY_LABELS_DEFINED_WHEN_UNLOCKED: "No project labels defined. When unlocked, you can define project-specific sensitivaty labels in addition to any organization-level labels.",
            LOADING_ORGANIZATION_LABELS: "Loading organization labels...",
            LOADING_PROJECT_LABELS: "Loading project labels...",
            LOADING_PROJECT_SECURITY_LABELS: "Loading project sensitivaty labels...",
            PROJECT_LEVEL_SECURITY_LABEL: "Project-level sensitivaty label",
            WHEN_LOCKED_AT_ORG_LEVEL_PROJECT_ADMINS: "When locked at the organization level, project administrators",
            ORG_SECURITY_LABELS: "Org Sensitivaty Labels",
            ORG_TAGS: "Org Tags",
    ...
    es: {
        translations: {
            ...
            DEFINE_ORGANIZATION_LEVEL_SENSITIVATY_LABEL_DESCRIPTION: "Define una etiqueta de sensitividad a nivel de organización. Los proyectos heredan esta etiqueta y pueden usarla en sus activos.",
            SHOWING: "Mostrando",
            LOCKED: "Bloqueado",
