export const translations = {
    ...
    INSIGHT_ARCHIVED_TEMPLATE_CANNOT_BE_EDITED: "Archived templates cannot be edited",
    ...
    INSIGHT_MODEL_CONFIG_REQUIRED_FIELDS: "Model name and server URL are required.",
    ...
    INSIGHT_MODEL_EDITOR_DESCRIPTION: "Choose saved models for query, upload, and embedding. You can also create project-level configs here and store your personal token when a model requires one.",
    ...
    INSIGHT_MODEL_SETTINGS_DESCRIPTION: "Choose the approved model templates Insight should use in this project. Nexus Model uses the backend defaults, and custom templates can use your personal API token when required.",
    INSIGHT_MODEL_TEMPLATE: "Insight Model Template",
    INSIGHT_MODEL_TEMPLATE_DESCRIPTION: "Set project-level model templates for Query, Upload / OCR, and Embedding. Users can choose these templates in Insight and attach their own token when needed.",
    ...
    INSIGHT_NO_PROJECT_TEMPLATES_FOR_ROLE: "No project templates exist for this role yet. Create one here to override the inherited organization default.",
    ...
    INSIGHT_CURRENT_USER_REQUIRED: "Current user information is required to save a model token.",
    INSIGHT_CURRENT_ACTIVE_TEMPLATE: "Current active template",
    INSIGHT_DEFAULT_MODEL: "Set as default model for this type",
    INSIGHT_DEFAULT_TEMPLATE_CANNOT_BE_ARCHIVED: "Default templates cannot be archived",
    INSIGHT_EDIT_MODEL_CONFIG: "Edit Project Model Config",
    INSIGHT_EDIT_MODEL_EDITOR_DESCRIPTION: "Update the selected model configuration for this project.",
    ...
    INSIGHT_EMBEDDING_MODEL_DESCRIPTION: "Used when Insight embeds document chunks for retrieval.",
    INSIGHT_NEW_MODEL: "New Model",
    INSIGHT_ORGANIZATION_CONFIG: "Organization",
    INSIGHT_ORGANIZATION_DEFAULTS_DESCRIPTION: "Organization defaults set the approved fallback template for each model type across the organization.",
    INSIGHT_ORGANIZATION_DEFAULTS_SAVED: "Organization Insight defaults saved.",
    INSIGHT_ORGANIZATION_DEFAULT_TEMPLATE: "Organization default template",
    INSIGHT_ORGANIZATION_EMBEDDING_DEFAULT_DESCRIPTION: "Organization default template for document embeddings.",
    INSIGHT_ORGANIZATION_QUERY_DEFAULT_DESCRIPTION: "Organization default language model template used for Insight chat.",
    INSIGHT_ORGANIZATION_TEMPLATES_LOAD_FAILED: "Failed to load organization Insight templates.",
    INSIGHT_ORGANIZATION_TEMPLATES_MANAGE_DESCRIPTION: "Create, edit, archive, and review organization templates available to your users.",
    INSIGHT_ORGANIZATION_TEMPLATE_EDITOR_DESCRIPTION: "Organization templates define approved model connection settings. Users will attach their own token later if the template requires one.",
    INSIGHT_ORGANIZATION_UPLOAD_DEFAULT_DESCRIPTION: "Organization default vision template used for upload and OCR processing.",
    INSIGHT_PROJECT_CONFIG: "Project",
    INSIGHT_PROJECT_CONTEXT_REQUIRED: "Organization and project context are required to save a model config.",
    INSIGHT_PROJECT_DEFAULTS_DESCRIPTION: "Project defaults override inherited organization templates for the matching model type. If no project override exists, the active template stays inherited.",
    INSIGHT_PROJECT_DEFAULTS_SAVED: "Project Insight defaults saved.",
    INSIGHT_PROJECT_DEFAULT_TEMPLATE: "Project default template",
    INSIGHT_PROJECT_EMBEDDING_DEFAULT_DESCRIPTION: "Project default template for document embeddings.",
    INSIGHT_PROJECT_QUERY_DEFAULT_DESCRIPTION: "Project default language model template used for Insight chat.",
    INSIGHT_PROJECT_TEMPLATES_LOAD_FAILED: "Failed to load project Insight templates.",
    INSIGHT_PROJECT_TEMPLATES_MANAGE_DESCRIPTION: "Create, edit, archive, and review project templates. Inherited organization templates are shown here for reference.",
    INSIGHT_PROJECT_TEMPLATE_EDITOR_DESCRIPTION: "Project templates define approved model connection settings. Users will attach their own token later if the template requires one.",
    INSIGHT_PROJECT_UPLOAD_DEFAULT_DESCRIPTION: "Project default vision template used for upload and OCR processing.",
    INSIGHT_NOT_READY_MESSAGE: "This record is not ready yet. Queue it first and wait for status to become Ready.",
    INSIGHT_CLICK_CREATE_TEMPLATE_TO_ADD_ONE: "Click Create Template to add one.",
    INSIGHT_QUEUEING: "Queueing...",
    INSIGHT_QUEUE_RECORD: "Queue Record For Insight",
    INSIGHT_QUERY_MODEL: "Query Model",
    INSIGHT_QUERY_MODEL_DESCRIPTION: "Used when you ask Insight a question in chat.",
    INSIGHT_ACTIVE_MODEL: "Active",
    INSIGHT_MANAGE_TOKEN: "Manage Token",
    INSIGHT_NO_ORGANIZATION_TEMPLATES_FOR_ROLE: "No organization templates exist for this role yet. Create one here to set the organization default.",
    ...
    INSIGHT_SHARED_CONFIG_READ_ONLY: "This config comes from the organization scope. It can be selected here, but only project-scoped configs can be edited from this modal.",
    ...
    INSIGHT_TOKEN_REQUIRED: "This model requires a personal API token before Insight can use it.",
    INSIGHT_TOKEN_SAVED: "Token saved",
    INSIGHT_TOKEN_SAVED_DESCRIPTION: "You already have a saved token for this model. Update it here if it changed.",
    INSIGHT_TOGGLE_TOKEN_VISIBILITY: "Toggle token visibility",
    INSIGHT_TOKENS_REQUIRED_BEFORE_SAVE: "Save tokens for every selected model that requires one before saving your selection",
    ...
    INSIGHT_UPLOAD_MODEL_DESCRIPTION: "Used when Insight queues files for ingestion and vision-assisted parsing.",
    ...
    INSIGHT_ARCHIVED_TEMPLATE_CANNOT_BE_EDITED: "Las plantillas archivadas no se pueden editar",
    INSIGHT_MODEL_CONFIG_ARCHIVED: "La configuración del modelo de Insight fue archivada.",
    INSIGHT_MODEL_CONFIG_UNARCHIVED: "La configuración del modelo de Insight fue restaurada.",
    INSIGHT_MODEL_CONFIG_REQUIRED_FIELDS: "El nombre del modelo y la URL del servidor son obligatorios.",
    INSIGHT_MODEL_CONFIG_SAVED: "La configuración del modelo de Insight se guardó correctamente.",
    INSIGHT_MODEL_CONFIGS_FAILED: "No se pudieron cargar las configuraciones de modelos de Insight.",
    INSIGHT_MODEL_EDITOR_DESCRIPTION: "Elige los modelos para consulta, carga e incrustación. También puedes crear configuraciones de proyecto aquí y guardar tu token personal cuando un modelo lo requiera.",
    ...
    INSIGHT_MODEL_SETTINGS_DESCRIPTION: "Elige las plantillas de modelo aprobadas que usará Insight en este proyecto. Nexus Model usa los valores predeterminados del backend y las plantillas personalizadas pueden usar tu token de API cuando sea necesario.",
    INSIGHT_MODEL_TEMPLATE: "Plantilla de modelo de Insight",
    INSIGHT_MODEL_TEMPLATE_DESCRIPTION: "Configura plantillas de modelo del proyecto para Consulta, Carga / OCR e Incrustación. Los usuarios pueden elegir estas plantillas en Insight y agregar su propio token cuando sea necesario.",
    INSIGHT_MODEL_TOKEN_SAVED: "El token del modelo de Insight se guardó correctamente.",
    ...
    INSIGHT_NO_PROJECT_TEMPLATES_FOR_ROLE: "Todavía no existen plantillas de proyecto para este rol. Crea una aquí para reemplazar la plantilla heredada de la organización.",
    ...
    INSIGHT_CURRENT_USER_REQUIRED: "Se requiere la información del usuario actual para guardar un token de modelo.",
    INSIGHT_CURRENT_ACTIVE_TEMPLATE: "Plantilla activa actual",
    INSIGHT_DEFAULT_MODEL: "Establecer como modelo predeterminado para este tipo",
    INSIGHT_DEFAULT_TEMPLATE_CANNOT_BE_ARCHIVED: "Las plantillas predeterminadas no se pueden archivar",
    INSIGHT_EDIT_MODEL_CONFIG: "Editar configuración de modelo del proyecto",
    INSIGHT_EDIT_MODEL_EDITOR_DESCRIPTION: "Actualiza la configuración del modelo seleccionado para este proyecto.",
    ...
    INSIGHT_EMBEDDING_MODEL_DESCRIPTION: "Se usa cuando Insight incrusta fragmentos de documentos para recuperación.",
    INSIGHT_NEW_MODEL: "Nuevo modelo",
    INSIGHT_ORGANIZATION_CONFIG: "Organización",
    INSIGHT_ORGANIZATION_DEFAULTS_DESCRIPTION: "Los valores predeterminados de la organización establecen la plantilla de respaldo aprobada para cada tipo de modelo en toda la organización.",
    INSIGHT_ORGANIZATION_DEFAULTS_SAVED: "Se guardaron los valores predeterminados de Insight para la organización.",
    INSIGHT_ORGANIZATION_DEFAULT_TEMPLATE: "Plantilla predeterminada de la organización",
    INSIGHT_ORGANIZATION_EMBEDDING_DEFAULT_DESCRIPTION: "Plantilla predeterminada de la organización para incrustaciones de documentos.",
    INSIGHT_ORGANIZATION_QUERY_DEFAULT_DESCRIPTION: "Plantilla predeterminada de la organización para el modelo de lenguaje usado en el chat de Insight.",
    INSIGHT_ORGANIZATION_TEMPLATES_LOAD_FAILED: "No se pudieron cargar las plantillas de Insight de la organización.",
    INSIGHT_ORGANIZATION_TEMPLATES_MANAGE_DESCRIPTION: "Crea, edita, archiva y revisa las plantillas de la organización disponibles para tus usuarios.",
    INSIGHT_ORGANIZATION_TEMPLATE_EDITOR_DESCRIPTION: "Las plantillas de la organización definen configuraciones aprobadas de conexión del modelo. Los usuarios agregarán su propio token después si la plantilla lo requiere.",
    INSIGHT_ORGANIZATION_UPLOAD_DEFAULT_DESCRIPTION: "Plantilla predeterminada de la organización para el procesamiento de carga y OCR.",
    INSIGHT_PROJECT_CONFIG: "Proyecto",
    INSIGHT_PROJECT_CONTEXT_REQUIRED: "Se requiere el contexto de organización y proyecto para guardar una configuración de modelo.",
    INSIGHT_PROJECT_DEFAULTS_DESCRIPTION: "Los valores predeterminados del proyecto reemplazan las plantillas heredadas de la organización para el mismo tipo de modelo. Si no existe una anulación del proyecto, la plantilla activa sigue siendo la heredada.",
    INSIGHT_PROJECT_DEFAULTS_SAVED: "Se guardaron los valores predeterminados del proyecto para Insight.",
    INSIGHT_PROJECT_DEFAULT_TEMPLATE: "Plantilla predeterminada del proyecto",
    INSIGHT_PROJECT_EMBEDDING_DEFAULT_DESCRIPTION: "Plantilla predeterminada del proyecto para incrustaciones de documentos.",
    INSIGHT_PROJECT_QUERY_DEFAULT_DESCRIPTION: "Plantilla predeterminada del proyecto para el modelo de lenguaje usado en el chat de Insight.",
    INSIGHT_PROJECT_TEMPLATES_LOAD_FAILED: "No se pudieron cargar las plantillas de Insight del proyecto.",
    INSIGHT_PROJECT_TEMPLATES_MANAGE_DESCRIPTION: "Crea, edita, archiva y revisa las plantillas del proyecto. Las plantillas heredadas de la organización se muestran aquí como referencia.",
    INSIGHT_PROJECT_TEMPLATE_EDITOR_DESCRIPTION: "Las plantillas del proyecto definen configuraciones aprobadas de conexión del modelo. Los usuarios agregarán su propio token después si la plantilla lo requiere.",
    INSIGHT_PROJECT_UPLOAD_DEFAULT_DESCRIPTION: "Plantilla predeterminada del proyecto para el procesamiento de carga y OCR.",
    INSIGHT_NOT_READY_MESSAGE: "Este registro aún no está listo. Ponlo en cola primero y espera a que el estado cambie a Listo.",
    INSIGHT_CLICK_CREATE_TEMPLATE_TO_ADD_ONE: "Haz clic en Crear plantilla para agregar una.",
    INSIGHT_QUEUEING: "Encolando...",
    INSIGHT_QUEUE_RECORD: "Poner registro en cola para Insight",
    INSIGHT_QUERY_MODEL: "Modelo de consulta",
    INSIGHT_QUERY_MODEL_DESCRIPTION: "Se usa cuando haces una pregunta a Insight en el chat.",
    INSIGHT_ACTIVE_MODEL: "Activo",
    INSIGHT_MANAGE_TOKEN: "Administrar token",
    INSIGHT_NO_ORGANIZATION_TEMPLATES_FOR_ROLE: "Todavía no existen plantillas de organización para este rol. Crea una aquí para establecer el valor predeterminado de la organización.",
    INSIGHT_REQUIRES_TOKEN: "Este modelo requiere un token de usuario",
    INSIGHT_SAVE_ORGANIZATION_DEFAULTS: "Guardar valores predeterminados de la organización",
    INSIGHT_SAVE_PROJECT_DEFAULTS: "Guardar valores predeterminados del proyecto",
    ...
    INSIGHT_SERVER_URL_PLACEHOLDER: "https://api.example.com/v1",
    INSIGHT_SELECT_ORGANIZATION_TEMPLATE: "Selecciona una plantilla de la organización",
    INSIGHT_SELECT_PROJECT_TEMPLATE: "Selecciona una plantilla del proyecto",
    INSIGHT_SHARED_CONFIG_READ_ONLY: "Esta configuración proviene del alcance de la organización. Puedes seleccionarla aquí, pero solo las configuraciones del proyecto pueden editarse desde este modal.",
    INSIGHT_STATUS_ERROR: "Error",
    ...
    INSIGHT_TOKEN_REQUIRED: "Este modelo requiere un token de API personal antes de que Insight pueda usarlo.",
    INSIGHT_TOKEN_SAVED: "Token guardado",
    INSIGHT_TOKEN_SAVED_DESCRIPTION: "Ya tienes un token guardado para este modelo. Actualízalo aquí si cambió.",
    INSIGHT_TOGGLE_TOKEN_VISIBILITY: "Mostrar u ocultar el token",
    INSIGHT_TOKENS_REQUIRED_BEFORE_SAVE: "Guarda tokens para cada modelo seleccionado que lo requiera antes de guardar tu selección",
    ...
    INSIGHT_UPLOAD_MODEL_DESCRIPTION: "Se usa cuando Insight pone archivos en cola para ingestión y análisis asistido por visión.",
