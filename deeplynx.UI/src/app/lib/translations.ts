export const translations = {
  en: {
    translations: {
      ...
      AFTER: "After",
      APPLY: "Apply",
      ACROSS_ALL_SOURCES: "Across all sources",
      ...
      API_KEYPAIR_CREATION_FAILED: "API Keypair creation failed.",
      API_KEYPAIR_DELETED_SUCCESS: "API Keypair deleted successfully!",
      API_KEYPAIR_DELETION_FAILED: "API Keypair deletion failed.",
      API_KEYS_DESCRIPTION: "Manage your API authentication keys",
      ...
      ENTER_ROLE_DESCRIPTION_OPTIONAL: "Enter role description (optional)",
      ...
      FAILED_TO_DELETE_PLEASE_TRY_AGAIN: "Failed to delete. Please try again.",
      FAILED_TO_LOAD_SAVED_SEARCHES: "Failed to load saved searches.",
      FILTER_SEARCHES: "Filter Searches",
      FILTERS: "Filters",
      FIND_SAVED_SEARCHES_BY_NAME: "Find saved searches by name...",
      ...
      FILTER_ALL_RESULTS: "Filter All Results",
      ...
      FILTER_BY_PROJECT_NAME: "Filter by project name...",
      ...
      GENERATE_FIRST_KEYPAIR: "Generate your first keypair to get started",
      ...
      LOADING_DATASOURCES: "Loading datasources...",
      ...
      NO_API_KEYS_CONFIGURED: "No API keypairs configured",
      ...
      READ_DATA_SOURCE: "Read Data Source",
      RUNNING_SAVED_SEARCH: "Running saved search...",
      READ_EDGE: "Read Edge",
      READ_FILE: "Read File",
      READ_GROUP: "Read Group",
      READ_INSIGHT: "Read Insight",
      RESET_FILTERS: "Reset Filters",
      READ_OBJECT_STORAGE: "Read Object Storage",
      READ_ORGANIZATION: "Read Organization",
      READ_PERMISSION: "Read Permission",
      READ_PROJECT: "Read Project",
      READ_RECORD: "Read Record",
      READ_RECORD_COLLECTION: "Read Record Collection",
      READ_RELATIONSHIP: "Read Relationship",
      READ_ROLE: "Read Role",
      READ_SENSITIVITY_LABEL: "Read Sensitivity Label",
      READ_TAG: "Read Tag",
      READ_USER: "Read User",
      ROLE: "Role",
      ...
      UPDATE_EDGES: "Update Edges",
      UPDATE_FILES: "Update Files",
      UPDATE_GROUPS: "Update Groups",
      UPDATE_OBJECT_STORAGES: "Update Object Storages",
      UPDATE_ORGANIZATIONS: "Update Organizations",
      UPDATE_PERMISSIONS: "Update Permissions",
      UPDATE_PROJECTS: "Update Projects",
      UPDATE_RECORD_COLLECTION: "Update Record Collection",
      UPDATE_RECORDS: "Update Records",
      UPDATE_RELATIONSHIPS: "Update Relationships",
      UPDATE_ROLES: "Update Roles",
      UPDATE_SENSITIVITY_LABELS: "Update Sensitivity Labels",
      ...
      USER: "User",
      UPDATED: "updated",
      USER_ROLE_LIMITED_PERMISSIONS: "User role with limited permissions",
      ...
      USER_ROLE_WITH_LIMITED_PERMISSIONS: "User role with limited permissions",
      ...
      WRITE_DATA_SOURCE: "Write Data Source",
      WRITE_EDGE: "Write Edge",
      WRITE_FILE: "Write File",
      WRITE_GROUP: "Write Group",
      WRITE_INSIGHT: "Write Insight",
      WRITE_OBJECT_STORAGE: "Write Object Storage",
      ...
      WRITE_RECORD_COLLECTION: "Write Record Collection",
      WRITE_RELATIONSHIP: "Write Relationship",
      WRITE_ROLE: "Write Role",
      WRITE_SENSITIVITY_LABEL: "Write Sensitivity Label",
      WRITE_TAG: "Write Tag",
  ...
  es: {
    translations: {
      ...
      ACROSS_ALL_SOURCES: "En todas las fuentes",
      ...
      CANCEL: "Cancelar",
      CONTAINS_TEXT_SEARCH: "Contiene búsqueda de texto...",
      ...
      FILTER_BY_DATA_SOURCE: "Filtrar por fuente de datos...",
      FILTER_BY_ENTITY_NAME: "Filtrar por nombre de entidad...",
      FILTER_BY_ENTITY_TYPE: "Filtrar por tipo de entidad...",
      FILTER_BY_OPERATION: "Filtrar por operación...",
      FILTER_BY_PROJECT_NAME: "Filtrar por nombre del proyecto...",
      ...
      FAILED_TO_CREATE_ROLE: "No se pudo crear el rol",
      ...
      GENERATE_FIRST_KEYPAIR: "Genera tu primer par de claves para comenzar",
      ...
      INSTANCE_DEFAULT: "Instancia predeterminada",
      ...
      LOADING_DATASOURCES: "Cargando fuentes de datos...",
      ...
      NO_DATASOURCES_FOUND: "No se encontraron fuentes de datos",
      NO_TAGS_FOUND: "No se encontraron etiquetas",
      NO_AVAILABLE_USERS: "No hay usuarios disponibles",
      NO_API_KEYS_CONFIGURED: "No hay pares de claves API configurados",
      ...
      PRIVATE_REQUEST_ACCESS: "Privado - solicitar acceso",
      PROJECT_LEVEL_ROLE_CREATION_AND_PERMISSION_MODIFICATION_DESCRIPTION:
      ...
      QUERY_BREAKDOWN: "Desglose de la consulta",
      READY: "Listo",
      READ: "leer",
      ...
      RELATIONSHIP_UPDATED: "Relación actualizada.",
      RECORD_NAME_UPDATED: "Nombre del registro actualizado",
      RECORDS: "Registros",
      RECORD_COLLECTION: "Colección de registros",
      ...
      RUNNING_SAVED_SEARCH: "Ejecutando búsqueda guardada...",
      REPLACES_THE_FOLDER_ICON_NEXT_TO_THE_PROJECT_NAME:
      ...
      READ_CLASS: "Leer clase",
      READ_DATA_SOURCE: "Leer fuente de datos",
      READ_EDGE: "Leer arista",
      READ_FILE: "Leer archivo",
      READ_GROUP: "Leer grupo",
      READ_INSIGHT: "Leer Insight",
      READ_OBJECT_STORAGE: "Leer almacenamiento de objetos",
      READ_ORGANIZATION: "Leer organización",
      READ_PERMISSION: "Leer permiso",
      READ_PROJECT: "Leer proyecto",
      READ_RECORD: "Leer registro",
      READ_RECORD_COLLECTION: "Leer colección de registros",
      READ_RELATIONSHIP: "Leer relación",
      READ_ROLE: "Leer rol",
      READ_SENSITIVITY_LABEL: "Leer etiqueta de sensibilidad",
      READ_TAG: "Leer etiqueta",
      ...
      UPDATE_CLASSES: "Actualizar clases",
      UPDATE_DATA_SOURCES: "Actualizar fuentes de datos",
      UPDATE_EDGES: "Actualizar aristas",
      UPDATE_FILES: "Actualizar archivos",
      UPDATE_GROUPS: "Actualizar grupos",
      UPDATE_OBJECT_STORAGES: "Actualizar almacenamientos de objetos",
      UPDATE_ORGANIZATIONS: "Actualizar organizaciones",
      UPDATE_PERMISSIONS: "Actualizar permisos",
      UPDATE_PROJECTS: "Actualizar proyectos",
      UPDATE_RECORD_COLLECTION: "Actualizar colección de registros",
      UPDATE_RECORDS: "Actualizar registros",
      UPDATE_RELATIONSHIPS: "Actualizar relaciones",
      UPDATE_ROLES: "Actualizar roles",
      UPDATE_SENSITIVITY_LABELS: "Actualizar etiquetas de sensibilidad",
      ...
      USER: "Usuario",
      USER_ROLE_LIMITED_PERMISSIONS: "Rol de usuario con permisos limitados",
      USER_AND_ORG_ADMIN_ACCESS_UPDATED:
      ...
      WIKI: "Wiki",
      WRITE: "escribir",
      WRITE_CLASS: "Escribir clase",
      WRITE_DATA_SOURCE: "Escribir fuente de datos",
      WRITE_EDGE: "Escribir arista",
      WRITE_FILE: "Escribir archivo",
      WRITE_GROUP: "Escribir grupo",
      WRITE_INSIGHT: "Escribir Insight",
      WRITE_OBJECT_STORAGE: "Escribir almacenamiento de objetos",
      WRITE_ORGANIZATION: "Escribir organización",
      WRITE_PERMISSION: "Escribir permiso",
      WRITE_PROJECT: "Escribir proyecto",
      WRITE_RECORD: "Escribir registro",
      WRITE_RECORD_COLLECTION: "Escribir colección de registros",
      WRITE_RELATIONSHIP: "Escribir relación",
      WRITE_ROLE: "Escribir rol",
      WRITE_SENSITIVITY_LABEL: "Escribir etiqueta de sensibilidad",
      WRITE_TAG: "Escribir etiqueta",
      WRITE_USER: "Escribir usuario",
      X_AXIS: "Eje X",
