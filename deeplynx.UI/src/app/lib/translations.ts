export const translations = {
    en: {
        translations: {
            ...
            LATTICE_ONTOLOGY_STATUS_TITLE: "Ontology Embeddings",
            LATTICE_ONTOLOGY_READY: "Ontology ready",
            LATTICE_ONTOLOGY_NOT_READY: "Ontology not fully embedded. Strict mode requires all classes and relationships to be embedded.",
            LATTICE_ONTOLOGY_NO_SCHEMA: "No classes or relationships in this project yet.",
            LATTICE_QUEUE_ONTOLOGY_EMBEDDINGS: "Queue Ontology Embeddings",
            LATTICE_ONTOLOGY_QUEUED_SUCCESS: "Ontology embeddings queued.",
            LATTICE_ONTOLOGY_QUEUE_FAILED: "Failed to queue ontology embeddings.",
            ...
            LATTICE_EXTRACTION_FAILED_MSG: "This extraction failed to complete.",
    ...
    es: {
        translations: {
            ...
            LATTICE_ONTOLOGY_STATUS_TITLE: "Incrustaciones de ontología",
            LATTICE_ONTOLOGY_READY: "Ontología lista",
            LATTICE_ONTOLOGY_NOT_READY: "La ontología no está completamente incrustada. El modo estricto requiere que todas las clases y relaciones estén incrustadas.",
            LATTICE_ONTOLOGY_NO_SCHEMA: "Aún no hay clases ni relaciones en este proyecto.",
            LATTICE_QUEUE_ONTOLOGY_EMBEDDINGS: "Poner en cola las incrustaciones de ontología",
            LATTICE_ONTOLOGY_QUEUED_SUCCESS: "Incrustaciones de ontología en cola.",
            LATTICE_ONTOLOGY_QUEUE_FAILED: "Error al poner en cola las incrustaciones de ontología.",
            ...
            LATTICE_EXTRACTION_FAILED_MSG: "Esta extracción no pudo completarse.",
