export const translations = {
    ...
    INSIGHT_MODEL_SETTINGS_DESCRIPTION: "Pick the models Insight should use in this project and save your own API tokens when a selected model needs one.",
    ...
    INSIGHT_MODEL_SETTINGS_DESCRIPTION: "Selecciona los modelos que usará Insight en este proyecto y guarda tus propios tokens de API cuando un modelo seleccionado los requiera.",
