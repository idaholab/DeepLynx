export const translations = {
    en: {
        translations: {
            ...
            DEFINE_PROJECT_TAGS_AND_LABELS_DESCRIPTION: "Define project tags and security labels for classification, workflows, and access control.",
            SHOWING: "Showing",
            LOCKED: "Locked",
            UNLOCKED: "Unlocked",
            ...
            PROJECT_SECURITY_LABELS: "Project Security Labels",
            ...
            PROJECT_SECURITY_LABELS_DESCRIPTION_WITH_CUI: "Security labels (e.g., CUI) for attribute-based access control at the project level. This project also inherits any labels defined at the organization level.",
            ...
            SECURITY_LABELS_LOCKED_AT_ORG_LEVEL: "Security labels are locked at the organization level",
            CREATE_NEW_PROJECT_LABEL: "Create new project label",
            CREATE_NEW_SECURITY_LABEL: "Create new security label",
            ...
            CANNOT_DEFINE_ADDITIONAL_SECURITY_LABELS: "cannot define additional security labels",
            ...
            ORGANIZATION_SECURITY_LABELS: "Organization Security Labels",
            ORGANIZATION_SECURITY_LABELS_DESCRIPTION: "Security labels for attribute-based access control. All projects inherit these and can optionally add their own.",
            LABELS_LOCKED_BY_ORGANIZATION: "Labels are locked by the organization",
            SECURITY_LABELS_LOCKED_BY_ORGANIZATION: "Security labels are locked by the organization",
            NO_LABELS_MATCH_SEARCH: "No labels match your search.",
            NO_PROJECT_LABELS_MATCH_SEARCH: "No project labels match your search.",
            NO_SECURITY_LABELS_MATCH_SEARCH: "No security labels match your search.",
            ...
            NO_PROJECT_SECURITY_LABELS_DEFINED_WHEN_UNLOCKED: "No project labels defined. When unlocked, you can define project-specific security labels in addition to any organization-level labels.",
            LOADING_ORGANIZATION_LABELS: "Loading organization labels...",
            LOADING_PROJECT_LABELS: "Loading project labels...",
            LOADING_PROJECT_SECURITY_LABELS: "Loading project security labels...",
            PROJECT_LEVEL_SECURITY_LABEL: "Project-level security label",
            WHEN_LOCKED_AT_ORG_LEVEL_PROJECT_ADMINS: "When locked at the organization level, project administrators",
            ORG_SECURITY_LABELS: "Org Security Labels",
            ORG_TAGS: "Org Tags",
    ...
    es: {
        translations: {
            ...
            DEFINE_PROJECT_TAGS_AND_LABELS_DESCRIPTION: "Define etiquetas y etiquetas de sensibilidad del proyecto para clasificación, flujos de trabajo y control de acceso.",
            SHOWING: "Mostrando",
            LOCKED: "Bloqueado",
            ...
            PROJECT_SECURITY_LABELS: "Etiquetas de seguridad del proyecto",
            ...
            PROJECT_SECURITY_LABELS_DESCRIPTION_WITH_CUI: "Etiquetas de seguridad (p. ej., CUI) para control de acceso basado en atributos a nivel de proyecto. Este proyecto también hereda cualquier etiqueta definida a nivel de organización.",
            ...
            SECURITY_LABELS_LOCKED_AT_ORG_LEVEL: "Las etiquetas de seguridad están bloqueadas a nivel de organización",
            CREATE_NEW_PROJECT_LABEL: "Crear nueva etiqueta del proyecto",
            CREATE_NEW_SECURITY_LABEL: "Crear nueva etiqueta de seguridad",
            ...
            CANNOT_DEFINE_ADDITIONAL_SECURITY_LABELS: "no pueden definir etiquetas de seguridad adicionales",
            ...
            ORGANIZATION_SECURITY_LABELS: "Etiquetas de seguridad de la organización",
            ORGANIZATION_SECURITY_LABELS_DESCRIPTION: "Etiquetas de seguridad para control de acceso basado en atributos. Todos los proyectos las heredan y opcionalmente pueden agregar las suyas.",
            LABELS_LOCKED_BY_ORGANIZATION: "Las etiquetas están bloqueadas por la organización",
            SECURITY_LABELS_LOCKED_BY_ORGANIZATION: "Las etiquetas de seguridad están bloqueadas por la organización",
            ...
            NO_SECURITY_LABELS_MATCH_SEARCH: "Ninguna etiqueta de seguridad coincide con tu búsqueda.",
            ...
            NO_PROJECT_SECURITY_LABELS_DEFINED_WHEN_UNLOCKED: "No hay etiquetas de proyecto definidas. Cuando estén desbloqueadas, puedes definir etiquetas de seguridad específicas del proyecto además de las etiquetas de la organización.",
            LOADING_ORGANIZATION_LABELS: "Cargando etiquetas de la organización...",
            LOADING_PROJECT_LABELS: "Cargando etiquetas del proyecto...",
            LOADING_PROJECT_SECURITY_LABELS: "Cargando etiquetas de seguridad del proyecto...",
            PROJECT_LEVEL_SECURITY_LABEL: "Etiqueta de seguridad a nivel de proyecto",
            WHEN_LOCKED_AT_ORG_LEVEL_PROJECT_ADMINS: "Cuando están bloqueadas a nivel de organización, los administradores del proyecto",
            ORG_SECURITY_LABELS: "Etiquetas de seguridad de la organización",
