...
def test_count_datasources_org(client, organization, cleanup_org_datasources):
    """Test counting datasources at organization level."""
    # Get baseline count
    baseline_response = client.get(
        f"/organizations/{organization}/datasources/count"
    )
...
def test_count_datasources_org_excludes_archived(client, organization, cleanup_org_datasources):
    ...
    count_before = client.get(f"/organizations/{organization}/datasources/count")
    ...
    count_hidden = client.get(f"/organizations/{organization}/datasources/count")
