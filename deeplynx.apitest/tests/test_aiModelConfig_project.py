"""Tests for AI Model Config API endpoints (project-level)."""
...
@pytest.fixture
def cleanup_project_ai_model_configs(client, organization, project):
    """Track and cleanup project-level AI Model Configurations."""
    created_ids = []
    yield created_ids
    for config_id in created_ids:
        try:
            client.delete(f"/organizations/{organization}/projects/{project}/ai-model-configs/{config_id}")
        except:
            pass


@pytest.fixture
def test_ai_model_config(client, organization, project, cleanup_project_ai_model_configs):
    ...
    response = client.post(
        f"/organizations/{organization}/projects/{project}/ai-model-configs",
        json=payload
    )

    assert response.status_code == 200, f"Failed to create AI Model Config fixture: {response.text}"
    config_id = response.json()["id"]
    cleanup_project_ai_model_configs.append(config_id)
...
def test_create_project_ai_model_config(client, organization, project, cleanup_project_ai_model_configs):
    """Test creating a single AI Model Config at the project level."""
    ...
    if response.status_code == 200:
        cleanup_project_ai_model_configs.append(response.json()["id"])
...
def test_create_project_ai_model_config_missing_required_fields(client, organization, project):
...
def test_get_all_project_ai_model_configs(client, organization, project, cleanup_project_ai_model_configs):
    """Test retrieving all AI Model Configs at the project level."""
    payload = make_config_payload()
    ...
    if create_response.status_code == 200:
        cleanup_project_ai_model_configs.append(create_response.json()["id"])
...
def test_get_all_project_ai_model_configs_hides_archived_by_default(client, organization, project, cleanup_project_ai_model_configs):
    ...
    archive_response = client.patch(
        f"/organizations/{organization}/projects/{project}/ai-model-configs/{created_id}/archive",
        params={"archive": "true"}
    )
    ...
    get_response = client.get(f"/organizations/{organization}/projects/{project}/ai-model-configs")
...
def test_get_all_project_ai_model_configs_show_archived(client, organization, project, cleanup_project_ai_model_configs):
...
def test_get_project_ai_model_config_by_id(client, organization, project, cleanup_project_ai_model_configs):
    """Test retrieving a single AI Model Config by ID at the project level."""
    payload = make_config_payload()
    ...
    get_response = client.get(
        f"/organizations/{organization}/projects/{project}/ai-model-configs/{created_id}"
    )
...
def test_get_project_ai_model_config_not_found(client, organization, project):
    """Test that fetching a non-existent AI Model Config returns 404."""
    get_response = client.get(
        f"/organizations/{organization}/projects/{project}/ai-model-configs/999999999"
    )
...
def test_update_project_ai_model_config(client, organization, project, cleanup_project_ai_model_configs):
    """Test updating an AI Model Config at the project level."""
...
def test_update_project_ai_model_config_not_found(client, organization, project):
...
def test_archive_and_unarchive_project_ai_model_config(client, organization, project, cleanup_project_ai_model_configs):
    """Test archiving and unarchiving an AI Model Config at the project level."""
    payload = make_config_payload()
...
def test_archive_project_ai_model_config_not_found(client, organization, project):
    """Test that archiving a non-existent AI Model Config returns 404."""
    archive_response = client.patch(
        f"/organizations/{organization}/projects/{project}/ai-model-configs/999999999/archive",
        params={"archive": "true"}
    )
...
def test_delete_project_ai_model_config(client, organization, project, cleanup_project_ai_model_configs):
    """Test permanently deleting an AI Model Config at the project level."""
    payload = make_config_payload()
    ...
    all_configs_response = client.get(
        f"/organizations/{organization}/projects/{project}/ai-model-configs"
    )
...
def test_delete_project_ai_model_config_not_found(client, organization, project):
