...
public class LatticeExtractionBusiness : ILatticeExtractionBusiness
{
    ...
    private readonly InsightBusiness _insightBusiness;
    private readonly TokenBusiness _tokenBusiness;

    public LatticeExtractionBusiness(DeeplynxContext context, StagingContext stagingContext, InsightBusiness insightBusiness, TokenBusiness tokenBusiness)
    {
        _context = context;
